...
export class PageRequestDto {
    ...
    @ApiProperty({ description: 'optional - jangan gunakan ketika menggunakan page', default: '0 (number) , jangan gunakan skip ketika menggunakan page' })
    @IsNumber()
    @IsOptional()
    skip: number
    ...
    @ApiProperty({
        ...
        default: { _id: 0, password: 0, __v: 0 }
    })
    @IsObject()
    @IsOptional()
    projection: object
